package programmers.pccp.most_gifts;

import programmers.pccp.most_gifts.yjlee.Solution;
...
public class Practice {
    public static void main(String[] args) {
        ...
        print(2, solution.solution(friends1, gifts1));
        print(4, solution.solution(friends2, gifts2));
        print(0, solution.solution(friends3, gifts3));
    }
